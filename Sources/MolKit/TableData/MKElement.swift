...
class MKElements {
    private let _MKELEMTable: [MKElement] = [
        ...
        MKElement(  6, "C" , 2.50, 0.76, 0.76, 1.70,  4,    12.0107, 2.55, 11.2603,   1.262118, 0.40, 0.40, 0.40, "Carbon"),
        MKElement(  7, "N" , 3.07, 0.71, 0.71, 1.55,  4,    14.0067, 3.04, 14.5341,      -0.07, 0.05, 0.05, 1.00, "Nitrogen"),
        MKElement(  8, "O" , 3.50, 0.66, 0.66, 1.52,  2,    15.9994, 3.44, 13.6181,   1.461112, 1.00, 0.05, 0.05, "Oxygen"),
        ...
        MKElement( 15, "P" , 2.06, 1.07, 1.07, 1.80,  6,  30.973761, 2.19, 10.4867,     0.7465, 1.00, 0.50, 0.00, "Phosphorus"),
        MKElement( 16, "S" , 2.44, 1.05, 1.05, 1.80,  6,     32.065, 2.58,   10.36,  2.0771029, 0.70, 0.70, 0.00, "Sulfur"),
    ...
    class func getAtomicNum(_ symbol: String) -> Int {
        // retrive index of symbol in element_symbols array
        if let index = MKElements.sharedInstance.element_symbols.firstIndex(of: symbol) {
            return index
        }
        return 0
    }
...
//    func getAtomicNum(_ atomic_symb: String) -> UInt {
//        switch atomic_symb {
//        case "H":
//            return 1
//        case "He":
